...
import {
	defaultGenerateRppValues,
	generateRppSchema,
	type GenerateRppValues,
} from "@/schemas/generate-rpp";
import type { MDXEditorMethods } from "@mdxeditor/editor";

const initialMarkdown = getRppTemplate(
	defaultGenerateRppValues.curriculum,
).emptyMarkdown;
...
export function RppGenerator() {
				...
				const fallbackMessage =
					data.code === "groq_config_error"
						...
						: data.code === "groq_rate_limited"
							? data.error ||
								"Layanan Groq sedang membatasi permintaan. Coba lagi beberapa saat."
	...
	function handleTemplateChange(
		nextCurriculum: GenerateRppValues["curriculum"],
	) {
		setValue("curriculum", nextCurriculum, {
			shouldDirty: true,
			shouldValidate: true,
		});
	}
	...
	function handleInputModeChange(
		nextInputMode: GenerateRppValues["inputMode"],
	) {
		setValue("inputMode", nextInputMode, {
			shouldDirty: true,
			shouldValidate: true,
		});
	}
	...
	return (
		<div className="space-y-6">
			...
			<FormSectionCard
				...
				description="Mode menentukan seberapa banyak field utama yang ditampilkan dan seberapa aktif AI melengkapi bagian yang masih kosong."
			>
				<div className="md:col-span-2">
					<InputModeSelector
						value={inputMode}
			...
			<FormSectionCard
				title="Isi konteks pembelajaran"
				description={
					inputMode === "full-ai"
						? "Isi field inti terlebih dahulu agar proses tetap cepat. Jika perlu, buka Data Tambahan untuk memberi arahan tambahan ke AI."
						: "Isi konteks utama pembelajaran secara lebih lengkap. Data Tambahan tetap tersedia untuk detail opsional agar form tetap rapi."
				}
			>
				<div className="md:col-span-2">
					...
					<div className="flex flex-col gap-3 border-b border-slate-200 p-5 lg:flex-row lg:items-center lg:justify-between">
						<div>
							...
							<p className="mt-1 text-sm text-slate-500">
								Hasil generate dimasukkan ke editor agar bisa langsung disunting
								sebelum diekspor.
							</p>
						</div>
